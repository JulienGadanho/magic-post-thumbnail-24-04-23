		...
		<div class="card card-custom wave wave-animate-slow wave-success">
			<div class="card-body">
				<div class="d-flex align-items-center p-5">
					<div class="mr-6">
              <span class="svg-icon svg-icon-success svg-icon-4x"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
              ...
              <p>
                  ...
                  <?php }
                      ...
                      ?>
                      <span class="plugin-infos"><a href="<?php echo $account_url ?>"><?php esc_html_e( 'Account', 'mpt' ); ?></a></span>
										<?php } ?>
              </p>
