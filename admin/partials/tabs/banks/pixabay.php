...
<tr valign="top">
	...
	<td>
		<input type="text" name="MPT_plugin_banks_settings[pixabay][username]" class="form-control" value="<?php echo( isset( $options['pixabay']['username'] ) && !empty( $options['pixabay']['username']) )? $options['pixabay']['username']: ''; ?>" >
	</td>
</tr>
<tr valign="top">
	<th scope="row">
	...
	<td id="password-pixabay" class="password">
		<input type="password" name="MPT_plugin_banks_settings[pixabay][apikey]" class="form-control" value="<?php echo( isset( $options['pixabay']['apikey'] ) && !empty( $options['pixabay']['apikey']) )? $options['pixabay']['apikey']: ''; ?>" >
