                            ...
                            <td>
															...
															<?php } ?>
																...
																<div>
																	...
																	<?php
																		$post_type_availables 	= array( get_option( 'MPT_plugin_posts_settings' ) );
																		$main_settings 					= array( get_option( 'MPT_plugin_main_settings' ) );
																		$banks_settings 				= array( get_option( 'MPT_plugin_banks_settings' ) );
																		$interval_settings 			= array( get_option( 'MPT_plugin_interval_settings' ) );
																	...
																	?>
																	<pre id="logs-block" class="settings-logs"><?php echo $settings; ?></pre>
																</div>
                            </td>
                    </tr>
