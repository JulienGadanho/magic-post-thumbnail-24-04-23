...
<div class="aside aside-left  aside-fixed  d-flex flex-column flex-row-auto" id="kt_aside">
	...
	<div class="aside-menu-wrapper flex-column-fluid">
        ...
        <?php $this->MPT_submenu(esc_html__( 'Posts', 'mpt' ), 'posts', 'settings.png' ); ?>
        <?php $this->MPT_submenu(esc_html__( 'Images', 'mpt' ), 'images' ); ?>
        <?php $this->MPT_submenu(esc_html__( 'Source', 'mpt' ), 'source', 'source.png' ); ?>
        <?php $this->MPT_submenu(esc_html__( 'Interval', 'mpt' ), 'interval', 'interval.png' ); ?>
