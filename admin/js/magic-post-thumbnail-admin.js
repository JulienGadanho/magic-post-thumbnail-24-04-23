window.onload = function(){
  ...
  setTimeout(function (){
      ...
      var gutenbergPostButton = jQuery('.edit-post-sidebar__panel-tab'); // #post-button-generate
...
function displayGenerationButton(gutenbergEditor = true) {
    ...
    var outline =  '<div class="button button-primary button-hero '+ uniqueButtonIdentifier +'" id="post-button-generate">';
    ...
    jQuery( '#post-button-generate.'+uniqueButtonIdentifier ).click(function(e) {
        ...
        // Button Animation
        jQuery('.button-hero > .icon-dashboard').addClass('generate');
        jQuery('#post-button-generate .no-generation').hide();
        jQuery('#post-button-generate .generation').show();
...
jQuery(document).ready(function() {
    ...
    hideAPIKey("#password-shutterstock");
    hideAPIKey("#password-gettyimage");
